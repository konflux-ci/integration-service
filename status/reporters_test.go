...
var _ = Describe("GitHubReporter", func() {
		...
		pipelineRun = &tektonv1beta1.PipelineRun{
			ObjectMeta: metav1.ObjectMeta{
				...
				Annotations: map[string]string{
					"test.appstudio.openshift.io/repo-url": "https://github.com/devfile-sample/devfile-sample-go-basic",
				},
			},
		}
	...
	Context("when provided GitHub app credentials", func() {
		...
		BeforeEach(func() {
			pipelineRun.Annotations["test.appstudio.openshift.io/installation-id"] = "123"
		...
		It("doesn't report status for non-pull request events", func() {
			delete(pipelineRun.Labels, "test.appstudio.openshift.io/event-type")
		...
		It("doesn't report status when the credentials are invalid/missing", func() {
			...
			pipelineRun.Annotations["test.appstudio.openshift.io/installation-id"] = "bad-installation-id"
	...
	Context("when provided GitHub webhook integration credentials", func() {
		...
		BeforeEach(func() {
			pipelineRun.Annotations["test.appstudio.openshift.io/pull-request"] = "999"
