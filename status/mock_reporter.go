...
// ReportConsolidatedStatus mocks base method.
func (m *MockReporterInterface) ReportConsolidatedStatus(arg0 context.Context, arg1 []TestReport) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReportConsolidatedStatus", arg0, arg1)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReportConsolidatedStatus indicates an expected call of ReportConsolidatedStatus.
func (mr *MockReporterInterfaceMockRecorder) ReportConsolidatedStatus(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReportConsolidatedStatus", reflect.TypeOf((*MockReporterInterface)(nil).ReportConsolidatedStatus), arg0, arg1)
}
...
func (mr *MockReporterInterfaceMockRecorder) ReturnCodeIsUnrecoverable(statusCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReporterInterfaceMockRecorder) UpdateStatusInComment(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
