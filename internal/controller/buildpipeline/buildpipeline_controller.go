...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	version, _ := pipelineRun.Annotations[tektonconsts.PipelineRunComponentVersionAnnotation]
	if version == "" {
		...
		adapter = NewAdapterFromApplication(ctx, pipelineRun, component, application, logger, loader, r.Client)
	} else {
