...
// validateRequiredScenarios checks if required scenarios exist and marks snapshot accordingly
// Returns the result and error exactly like the original inline code
func (a *Adapter) validateRequiredScenarios() (controller.OperationResult, error) {
...
func (a *Adapter) EnsureIntegrationPipelineRunsExist() (controller.OperationResult, error) {
	...
	result, err := a.validateRequiredScenarios()
