...
// EnsureGroupSnapshotCreationStatusReportedToGitProvider is an operation that will ensure the the group snapshot creation status is report to component snapshot
func (a *Adapter) EnsureGroupSnapshotCreationStatusReportedToGitProvider() (controller.OperationResult, error) {
	// Only report status for component Snapshots
