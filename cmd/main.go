...
import (
	...
	appstudiov1alpha1 "github.com/konflux-ci/integration-service/api/v1alpha1"
	appstudiov1beta1 "github.com/konflux-ci/integration-service/api/v1beta1"
	...
	webhookappstudiov1beta2 "github.com/konflux-ci/integration-service/internal/webhook/v1beta2"
...
func init() {
	...
	utilruntime.Must(appstudiov1beta2.AddToScheme(scheme))
...
func main() {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookappstudiov1beta2.SetupIntegrationTestScenarioWebhookWithManager(mgr); err != nil {
