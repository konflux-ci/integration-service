...
require (
	...
	github.com/redhat-appstudio/application-service v0.0.0-20220310134421-5864c77a3d17 // indirect
	github.com/redhat-appstudio/release-service v0.0.0-20220510133339-e27e49c2d6b5 // indirect
