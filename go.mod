...
require (
	...
	github.com/konflux-ci/coverport/instrumentation/go v0.0.0-20260804111544-3495502abfd4
...
replace (
	...
	knative.dev/pkg => knative.dev/pkg v0.0.0-20260727151759-521cb33b33dd
)
