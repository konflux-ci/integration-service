...
const (
	...
	ComponentGroupLabelPrefix = "integration.konflux-ci.dev/component-group"

	// TestLabelPrefix contains the prefix applied to labels and annotations related to integration testing.
	TestLabelPrefix = "integration.konflux-ci.dev"
