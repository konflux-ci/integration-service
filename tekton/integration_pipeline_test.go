...
var _ = Describe("Integration pipeline", func() {
	...
	FContext("When creating a new IntegrationPipelineRun", func() {
		...
		It("Can create an IntegrationPipelineRun from a scenario that resolves to a PipelineRun", func() {
			integrationTestScenarioGit = &v1beta2.IntegrationTestScenario{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-with-pipelinerun",
					Namespace: "default",
