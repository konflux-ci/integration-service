...
func PrepareSnapshotForPipelineRun(ctx context.Context, adapterClient client.Client, pipelineRun *tektonv1.PipelineRun, componentName string, componentGroup *v1beta2.ComponentGroup, loader loader.ObjectLoader) (*applicationapiv1alpha1.Snapshot, error) {
	...
	newSnapshotComponent := createSnapshotComponent(componentName, componentVersion, newContainerImage, componentSource)
	snapshot, err := PrepareSnapshot(ctx, adapterClient, componentGroup, newSnapshotComponent)
	if err != nil {
		return nil, err
	}
...
func PrepareSnapshot(ctx context.Context, adapterClient client.Client, componentGroup *v1beta2.ComponentGroup, newSnapshotComponent applicationapiv1alpha1.SnapshotComponent) (*applicationapiv1alpha1.Snapshot, error) {
...
func upsertNewComponentImage(snapshotComponents *[]applicationapiv1alpha1.SnapshotComponent, invalidComponents *[]v1beta2.ComponentState, updatedComponent applicationapiv1alpha1.SnapshotComponent, log logr.Logger) (*[]applicationapiv1alpha1.SnapshotComponent, *[]v1beta2.ComponentState) {
...
func createSnapshotComponent(componentName, componentVersion, containerImage string, componentSource *applicationapiv1alpha1.ComponentSource) applicationapiv1alpha1.SnapshotComponent {
